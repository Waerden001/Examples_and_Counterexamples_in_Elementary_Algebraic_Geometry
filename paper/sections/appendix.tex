...
\textbf{Model output (Opus, verbatim excerpt from Steps 2--4 of the 5{,}443-character response; Markdown headings and display math adapted to \LaTeX\ formatting):}
