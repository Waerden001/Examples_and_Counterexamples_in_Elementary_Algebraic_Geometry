...
$$
\begin{aligned}
\Omega_{\Sigma_{n}/\mathbf{P}^1}&=\mathcal{O}_{\Sigma_{n}}(-2, 0)\otimes \pi^{*}(\det \mathcal{E})=\mathcal{O}_{\Sigma_{n}}(-2,n)\\
T_{\Sigma_{n}/\mathbf{P}^1}&=\mathcal{O}_{\Sigma_{n}}(2,-n)\\
\omega_{\Sigma_{n}}&=\mathcal{O}_{\Sigma_{n}}(-2, n-2).
\end{aligned}
$$
...
Buchdahl proved that [Buchdahl, 1987] the diagonal $\Delta$ can be realized as the zero locus of a global section $s$ of $\mathcal{G}$, then the Koszul complex of $s$ gives us the resolution of the diagonal $C^{\bullet}\twoheadrightarrow\mathcal{O}_{\Delta}$:
