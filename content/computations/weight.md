...
```latex
\begin{tikzcd}2 \arrow{r}{d_{1}}& 1\\
0 & 0\\
0 & 1\end{tikzcd}
```\Rightarrow E_{2}^{p,q}=Gr_{q}H^{p+q}(X)=<!-- tikzcd diagram: manual conversion needed -->
```latex
\begin{tikzcd}1 & 0\\
0 & 0\\
0 & 1\end{tikzcd}
...
[cubical hyperresolution](https://www.math.utah.edu/~schwede/Notes/NotesOnCubicalHyperresolutions.pdf)
[Some Remarks on Hyperresolutions, J.H.M. Steenbrink](https://link.springer.com/content/pdf/10.1007/978-3-319-28829-1_15.pdf)
...
- [de Rham-Witt complex](https://www3.nd.edu/~mbehren1/TAGS/Davis_notes.pdf)

## Nearby cycles

### Example: Tate twist {#ecag-0292}

[$p$-adic Tate twist](http://www.math.sci.hiroshima-u.ac.jp/algebra/agsympo/documents/Sato.pdf)

### Example: inertia group {#ecag-0293}

[Ramification group](https://en.wikipedia.org/wiki/Ramification_group)
...
[page 14](http://achinger.impan.pl/thesis.pdf)

### Example: Milnor fibration, nearby cycles of a family $X\rightarrow D$, [reference {#ecag-0296}
